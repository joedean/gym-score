...
RSpec.describe AthletesController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all athletes as @athletes" do
      ...
      expect(assigns(:athletes)).to eq([athlete])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new athlete as @athlete" do
      ...
      expect(assigns(:athlete)).to be_a_new(Athlete)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created athlete as @athlete" do
        post :create, {:athlete => valid_attributes}, valid_session
        expect(assigns(:athlete)).to be_a(Athlete)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved athlete as @athlete" do
        post :create, {:athlete => invalid_attributes}, valid_session
        expect(assigns(:athlete)).to be_a_new(Athlete)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested athlete" do
        athlete = Athlete.create! valid_attributes
        put :update, {:id => athlete.to_param, :athlete => new_attributes}, valid_session
        athlete.reload
    ...
    describe "with invalid params" do
      it "assigns the athlete as @athlete" do
        athlete = Athlete.create! valid_attributes
        put :update, {:id => athlete.to_param, :athlete => invalid_attributes}, valid_session
        expect(assigns(:athlete)).to eq(athlete)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the athletes list" do
      athlete = Athlete.create! valid_attributes
      delete :destroy, {:id => athlete.to_param}, valid_session
      expect(response).to redirect_to(athletes_url)
    end
  end
